...
const expectedGroups = {
  ...
  filterbank: ['DEV REFERENCE', 'DEV BAND BOOST', 'DEV BAND CUT', 'DEV WET MODEL'],
  'local-feedback': ['DEV FB TOPOLOGY', 'DEV LOCAL LOOP TUNING', 'DEV FB TAP', 'DEV FB SAT', 'DEV FB DRIVE', 'DEV FB CEILING'],
  main: ['DEV FB ALL ENGINE', 'DEV FB ALL SOURCE', 'DEV POST GAIN FB WEIGHT', 'DEV FB ALL LEVEL'],
